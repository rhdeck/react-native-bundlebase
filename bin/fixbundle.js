...
function addToPlists() {
    plists.map((path)=>{
        ...
        if(o.CFBundleIdentifier) {
            console.log("Found a bi", o.CFBundleIdentifier)
            if(o.CFBundleIdentifier.startsWith(defaultBase)) {
                if(homeinfo.bundleBase) {
                    o.CFBundleIdentifier = o.CFBundleIdentifier.replace(defaultBase, homeinfo.bundleBase);
